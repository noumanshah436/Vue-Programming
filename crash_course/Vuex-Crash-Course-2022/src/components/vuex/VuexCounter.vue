...
export default {
  ...
  methods: {
    clickIncrement: function () {
      // we can dispatch actions directly using 'this.$store.dispatch'
  ...
  // mapGetters is used to fetch the getter functions of store
  computed: mapGetters({
    counterState: "getCounterState"
    // whatever the function 'getCounterState' return will be assigned to the 'counterState' variable ( variable can have any name)
  })
}
</script>
